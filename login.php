...
<!-- <h1>Hoşgeldiniz</h1>
	...
	<div class="button-container" style="text-align:center; margin-top:1px;">
		<button style="width: 300px;"type="submit" class="btn btn-block btn-danger" onclick="location.href='akademisyen.php'">Akademisyen Girişi</button>
		<button type="submit" class="btn btn-block btn-danger"onclick="location.href='admin2/ogrenci.php'">Öğrenci Girişi</button>
