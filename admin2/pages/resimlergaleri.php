<div class="content-wrapper">
    ...
    <?php 
     if(isset($_POST['save'])){
      if($_POST['save'] == 1001){
        ...
        $sql = "INSERT INTO qp_ders(title, description, kod, kredi, user_id, statu) VALUES (?,?,?,?,?,?)"; 
        $args = [$title, $description, $kod, $kredi, $user_id, $statu];
    ...
    if(isset($_POST['update'])){
      if($_POST['update'] == 1002){
        ...
        $kredi = $_POST['kredi'];
        $statu = $_POST['statu'][0];
        $sql = "UPDATE qp_ders SET title=?,description=?, kod =?, kredi=?, statu = ? WHERE id = ? ";
        $args = [$title,$description,$kod, $kredi,$statu,$id];
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="kod" value="<?php print $value['kod']; ?>" >
                      </div>
                    </div> 
                  </div>
                  <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="kredi" value="<?php print $value['kredi']; ?>" >
                      </div>
                    </div> 
                  </div>
                  <div class="row">
