<div class="content-wrapper">
    ...
    <?php 
     if(isset($_POST['save'])){
      if($_POST['save'] == 1001){
        ...
        $sql = "INSERT INTO qp_about2(title, description, adddate, user_id, statu) VALUES (?,?,?,?,?)"; 
    ...
    if(isset($_POST['update'])){
      if($_POST['update'] == 1002){
        ...
        $statu = $_POST['statu'][0];
        $sql = "UPDATE qp_about2 SET title=?,description=?, statu = ? WHERE id = ? ";
      ...
      if (isset($_POST['dataDelete'])) {
        ...
        $sql = "DELETE FROM qp_about2 WHERE id = ?";
        $args = [$delete_id];
  ...
  <div class="modal fade" id="modal-default">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Yeni Öğrenci</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
